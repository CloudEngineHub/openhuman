...
const messages: TranslationMap = {
  ...
  'memorySources.repair.message':
    '最多 {scanned} 个已同步的文档在记忆树归档修复之前保存，因此不会显示在记忆图谱中。归档它们会消耗嵌入额度。已在记忆树中的文档会被跳过。',
  'memorySources.repair.confirm': '修复',
  'memorySources.repair.cancel': '暂不',
  'memorySources.repair.nothing': '无需修复 — 没有等待归档的已同步文档。',
  'memorySources.repair.success':
    '已归档 {ingested} 个到记忆树（{already} 个已存在，{skipped} 个已跳过）。',
