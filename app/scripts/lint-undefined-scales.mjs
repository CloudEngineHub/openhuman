...
const NON_COLOR_NAMES = {
  ...
  text: ['balance', 'center', 'clip', 'ellipsis', 'end', 'justify', 'left', 'nowrap', 'pretty', 'right', 'start', 'wrap'],
  border: [
    'b',
    'collapse',
    'dashed',
  ...
  divide: ['dashed', 'dotted', 'double', 'hidden', 'none', 'solid', 'x', 'x-reverse', 'y', 'y-reverse'],
  'divide-x': ['reverse'],
  'divide-y': ['reverse'],
  ...
  accent: ['auto'],
  caret: [],
  decoration: ['auto', 'clone', 'dashed', 'dotted', 'double', 'from-font', 'none', 'slice', 'solid', 'wavy'],
  placeholder: [],
};
